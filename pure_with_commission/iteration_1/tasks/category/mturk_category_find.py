...
title = 'Find a category of an auction item based on several images (receive a commission for good work)' 
description = ('Take a look at three pictures of an auction item and find a category')
keywords = 'image, categorization, picture, item, category, commission'
...
with open(path_groundtruth, 'rb') as csvfile:
    ...
    if length == len(titles):    
        for row in reader: 
            ...
            html_code += 'If the auction will be sucessful then the creators of the final category will receive <b>0.25% of the selling price as a bonus</b>. The final category will be determined by a voting procedure.<br /><br />'
