        ...
        <Question>
            ...
            <QuestionContent>
                <FormattedContent><![CDATA[
					...
					<table><tr>
					<td><img src="image1" alt="Image 1" width="250" border="2"></img></td>
					<td><img src="image2" alt="Image 2" width="250" border="2"></img></td>
					<td><img src="image3" alt="Image 3" width="250" border="2"></img></td>
					</tr>
					<tr>
					<td><a href="image1" target="_blank">Link to full size image 1 (new window)</a></td>
					<td><a href="image2" target="_blank">Link to full size image 2 (new window)</a></td>
					<td><a href="image3" target="_blank">Link to full size image 3 (new window)</a></td>
					</tr></table>
]]></FormattedContent>
            </QuestionContent>
            <AnswerSpecification>
