...
with open('../../../../ground_truth/groundTruth.csv', 'rb') as csvfile:
    ...
    for row in reader:
        ...
        html_code += '<br /><br />'         
        html_code += createWorkerTable('workerIds_find.csv', 5)
        html_code += '<hr />'        
        ...
        html_code = ""
        html_code += 'The goal of the requester of the HIT is to generate eBay auctions by MTurk workers based on images of the item'
